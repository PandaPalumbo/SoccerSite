...
import TeamPlayerStandings from "./TeamPlayerStandings";
...
export default {
  ...
  computed: {
    ...
    squad(){
      let data = this.data
      console.log(data)
          // server = server.squad.server.sort((a,b) => b.appearences - a.appearences);
      return data;
    },
    leagueStats() {
    ...
    // currentSeasonStats() {
    //   return this.server.seasons.server.filter(season => season.is_current_season)[0]
    // },
  },
  data() {
    return {
